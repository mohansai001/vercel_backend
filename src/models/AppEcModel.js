/**
 * App EC Model - Database table structure and field definitions
 * Used for building queries and understanding data structure during migration
 */

class AppEcModel {
  constructor() {
    this.tableName = 'App_EC';
    ...
    this.fields = {
      ...
      app_job_jd: {
        type: 'TEXT',
        description: 'App job JD s3 bucket link'
      },
      created_at: {
        type: 'TIMESTAMP',
        notNull: true,
    ...
    this.indexes = [
      { name: 'idx_app_ec_job_role', columns: ['job_role'] },
      { name: 'idx_app_ec_created_at', columns: ['created_at'] }
    ];
    ...
    this.sampleData = {
      ...
      app_job_jd: 'https://s3.amazonaws.com/jd/app-frontend-developer.pdf',

/**
 * Interview Roles Model - Database table structure and field definitions
 * Used for building queries and understanding data structure during migration
 */

class InterviewRolesModel {
  constructor() {
    this.tableName = 'InterviewRoles';
    ...
    this.fields = {
      ...
      roleName: {
        type: 'VARCHAR(255)',
        notNull: true,
        description: 'Name of the interview role'
      },
      created_at: {
        type: 'TIMESTAMP',
        notNull: true,
    ...
    this.indexes = [
      { name: 'idx_interview_roles_name', columns: ['roleName'] },
      { name: 'idx_interview_roles_created_at', columns: ['created_at'] }
    ];
...
module.exports = InterviewRolesModel; 